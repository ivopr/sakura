-- CreateTable
CREATE TABLE `sakura_accounts` (
    `account_id` INTEGER NOT NULL,
    `pronoun` ENUM('HE', 'SHE') NOT NULL DEFAULT 'SHE',
    `real_name` VARCHAR(128) NULL,

    UNIQUE INDEX `sakura_accounts_account_id_key`(`account_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `sakura_config` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `servername` VARCHAR(191) NOT NULL DEFAULT 'Mantis',
    `intalled_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),

    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `sakura_shop_offers` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
...
-- CreateTable
CREATE TABLE `sakura_shop_history` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `offer_id` INTEGER NOT NULL,
    `player_id` INTEGER NOT NULL,
    `bought_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
-- AddForeignKey
ALTER TABLE `sakura_accounts` ADD CONSTRAINT `sakura_accounts_account_id_fkey` FOREIGN KEY (`account_id`) REFERENCES `accounts`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
